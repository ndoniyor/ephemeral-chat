...
/**
 * @generated ServiceType for protobuf service grpc.ChatService
 */
export const ChatService = new ServiceType("grpc.ChatService", [
    ...
    { name: "FlushServer", options: {}, I: Empty, O: Empty }
]);
